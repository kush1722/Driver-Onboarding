  ...
  return (
    <div className="container">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <h1 style={{ margin: 0 }}>Application Queue</h1>
        <button onClick={handleSignOut} className="text-link" style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Sign out</button>
      </div>
      ...
      <div style={{ position: 'relative', marginBottom: '1.5rem' }}>
        ...
        <div style={{ position: 'absolute', top: 0, right: 0, bottom: '0.5rem', width: '3rem', background: 'linear-gradient(to right, transparent, var(--bg-color))', pointerEvents: 'none' }}></div>
      </div>
      ...
      <div style={{ position: 'relative', marginBottom: '1rem' }}>
        ...
        <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, width: '4rem', background: 'linear-gradient(to right, transparent, rgba(17, 24, 39, 0.9))', pointerEvents: 'none', borderTopRightRadius: '16px', borderBottomRightRadius: '16px' }}></div>
      </div>
